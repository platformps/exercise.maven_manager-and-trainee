 ...
 */
// Ensure an `AbstractEmployee` implements the `EmployeeInterface`
// Ensure an `AbstractEmployee` is abstract
abstract public class AbstractEmployee implements EmployeeInterface {
    //private Object exampleOfInstanceVariable - replaced with correct instance variable declarations
    private Long id;
    private String name;
